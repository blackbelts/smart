...
/**
 * Generated class for the CreateVendorTaxesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-create-vendor-taxes',
  templateUrl: 'create-vendor-taxes.html',
})
export class CreateVendorTaxesPage {
  taxName: any
  taxScopes = [
  ...
  parmList:any
  groupOfTaxesId: any = [];
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl: ViewController, public odooProv: OdooProvider, public modalCtrl: ModalController, public utils: UtilsProvider, public storage: Storage) {
